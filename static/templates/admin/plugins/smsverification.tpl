<form role="form" class="smsverification-settings">
  ...
  <div class="row">
    <div class="col-sm-2 col-xs-12 settings-header">国内短信</div>
    <div class="col-sm-10 col-xs-12">
      <div class="form-group">
  ...
  <div class="row">
    <div class="col-sm-2 col-xs-12 settings-header">国际短信</div>
    <div class="col-sm-10 col-xs-12">
      <div class="form-group">
        <label for="templateIdIntl">短信模板 ID，需要在短信控制台中申请</label>
        <input type="number" id="templateIdIntl" name="templateIdIntl" class="form-control" placeholder="templateId">
      </div>
      <div class="form-group">
        <label for="smsSignIntl">签名，签名参数使用的是`签名内容`，而不是`签名ID`</label>
        <input type="text" id="smsSignIntl" name="smsSignIntl" class="form-control" placeholder="smsSign">
      </div>
    </div>
  </div>
  <br>
